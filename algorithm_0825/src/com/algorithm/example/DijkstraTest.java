...
/**
 * 만약 모든 쌍의 최단거리를 다익스트라로 구하는 경우 인접행렬 기준 O(V^2) * V -> O(V^3) 만큼 되버린다.
 * -> 플로이드워샬로 더 쉽게 구현할 수 있다.
 */
public class DijkstraTest {
	public static void main(String[] args) throws IOException {
		...
		for (int i = 0; i < V; i++) {
			...
			//최솟값을 빠르게 찾기 위해서는 Priority Queue 사용해보기!!
			...
			for (int j = 0; j < V; j++) {
				//adjMatrix[minVertex][j] > 0: 입력값 보면 갈수있는경우는 0보다 크다
